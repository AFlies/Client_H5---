...
pickerDateRange.prototype.fillDate = function(year, month, index) {
	...
	if(isTaTheme){
		...
		if(!this.mOpts.magicSelect){
			if(0 == index) {
				$(td).append('<a href="javascript:void(0);" id="' + this.nextMonth + '"><i class="icon iconfont i_next">&#xe635;</i></a>');
			}
			// 如果是第一个月的日期，则加上上一个月的链接
			if(index + 1 == this.mOpts.calendars) {
				$(td).append('<a href="javascript:void(0);" id="' + this.preMonth + '"><i class="icon iconfont i_pre">&#xe636;</i></a>');
			}
		}
